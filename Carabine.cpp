				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"Carabiner\data\IceTool_damage.rvmat"
							}
						};
						...
						
						{
							...
							{
								"Carabiner\data\IceTool_destruct.rvmat"
							}
						}
					};
				};
